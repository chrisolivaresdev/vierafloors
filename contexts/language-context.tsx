...
const translations = {
  es: {
    ...
    portfolio: {
      ...
      ceramicTilesSale: "Cerámicas y Porcelanatos en Venta",
      ceramicTilesSaleDesc: "Venta directa de cerámicas importadas al mejor precio",
      chevronFloor: "Piso de Madera Chevron",
      chevronFloorDesc: "Instalación de piso cerámico con diseño tipo madera en patrón chevron de alta precisión.",
      ...
      marbleSlabDesc: "Porcelanato de gran formato con acabado tipo mármol para acabados de lujo.",
      ...
      porcelainWhite: "Porcelanato Blanco Pulido",
      porcelainWhiteDesc: "Lámina de porcelanato blanco con vetas sutiles para un acabado limpio y luminoso.",
      darkStairs: "Escaleras de Madera Oscura",
      darkStairsDesc: "Instalación de peldaños en madera oscura con contrahuellas blancas para un contraste moderno.",
      wpcCaramel: "Panel WPC Caramel",
      wpcCaramelDesc: "Revestimiento WPC en tono caramelo con textura de madera natural.",
      ...
      tileDisplayDesc: "Variedad de cerámicas y porcelanatos importados disponibles en nuestra sala de exhibición.",
      ...
      lightWood: "Tablones de Madera Clara",
      lightWoodDesc: "Selección de tablones cerámicos tipo madera clara para ambientes luminosos.",
      ...
      showroomSamplesDesc: "Explora nuestra amplia gama de muestras: grama artificial, cerámicas y maderas en stock.",
      ...
      blueMarbleShowerDesc: "Instalación de lujo con láminas de porcelanato tipo mármol azul y grifería dorada.",
      polishedFloor: "Piso de Sala Pulido",
      polishedFloorDesc: "Acabado de alto brillo en sala de estar con porcelanato beige de gran formato.",
      ...
      wpcChampagneWoodDesc: "Elegante revestimiento WPC con textura de madera en tono champagne.",
      ...
      calacattaSlab: "Porcelanato Calacatta Premium",
      calacattaSlabDesc: "Láminas de porcelanato blanco con vetas grises clásicas para un estilo atemporal.",
      luxuryDarkBathroom: "Baño de Lujo Moderno",
      luxuryDarkBathroomDesc: "Diseño de baño con porcelanato oscuro y detalles dorados para un ambiente sofisticado.",
      tealMarble: "Porcelanato Marmoleado Teal",
      tealMarbleDesc: "Lámina exótica de porcelanato con vetas en tonos teal y azul profundo.",
      wpcRedCherry: "Panel WPC Red Cherry",
      wpcRedCherryDesc: "Panel WPC con acabado en madera cerezo rojizo para un toque cálido y vibrante.",
      calacattaRack: "Exhibición Calacatta",
      calacattaRackDesc: "Opciones de porcelanato Calacatta disponibles en nuestro showroom.",
      ...
      tealMarble2Desc: "Otra perspectiva de nuestra exótica lámina de porcelanato marmoleado teal.",
      richWoodWPC: "Panel WPC Rich Wood",
      richWoodWPCDesc: "Revestimiento WPC con textura de madera profunda y rica para ambientes cálidos.",
      porcelainWarehouse: "Almacén de Porcelanato",
      porcelainWarehouseDesc: "Amplio inventario de láminas de porcelanato de gran formato listas para entrega.",
      ...
      luxuryShowerBlackDesc: "Instalación premium con piso hexagonal negro, paredes de porcelanato blanco y grifería negra.",
    },
    // Contact Section
    contact: {
      title: "Contáctanos",
